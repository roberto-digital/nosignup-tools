...
const NewsletterForm = () => {
  ...
  return (
    <div className="p-6 md:w-full xl:w-full mx-auto flex flex-col xl:items-stretch justify-center xl:flex-row">
      <div className="w-full xl:w-7/12 xl:pl-40 xl:py-28">
