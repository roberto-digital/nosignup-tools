...
function Button({
  ...
  if (submit)
    finalClass +=
      " text-white bg-gray-400 border-gray-400 hover:bg-gray-600 hover:border-gray-600";
    ...
    finalClass +=
      " text-white border border-white hover:bg-white hover:text-purple m-3 font-bold uppercase rounded outline-none focus:outline-none ease-linear transition-all duration-150";
  else if (type === "dark")
    finalClass +=
